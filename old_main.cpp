...
private:
    ...
    void loadModel(){
        ...
        //combining everything into a single mesh
    ...
    void createTextureImage(std::string textureFile) {
        ...
        std::cout << "Loaded image: " << texWidth << "x" << texHeight 
        ...
        //make layout optimal for transfer to buffer
