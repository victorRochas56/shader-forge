...
private:
    ...
    static void framebufferResizedCallback(GLFWwindow* window, int width, int height) {
        auto app = static_cast<ShaderForgeApplication*>(glfwGetWindowUserPointer(window));
    ...
    void drawFrame() {
        ...
        if (imagesInFlight[imageIndex] != VK_NULL_HANDLE) {
            vk::Result waitResult = device.waitForFences(imagesInFlight[imageIndex], vk::True, UINT64_MAX);
    ...
    void createGraphicsPipeline() {
        ...
        vk::GraphicsPipelineCreateInfo pipelineInfo{.pNext = &pipelineRenderingCreateInfo,
                                                    ...
                                                    .renderPass = nullptr, //renderPass is nullptr because we're using dynamic rendering instead of a traditional render pass
    ...
    void createDescriptorPool() {
        vk::DescriptorPoolSize poolSize(vk::DescriptorType::eUniformBuffer, MAX_FRAMES_IN_FLIGHT); //one is allocated per frame
    ...
    void createTextureImage(const char* filename) {
        ...
        //make layou optimal for transfer to buffer
        transitionImageLayout(textureImage, vk::ImageLayout::eUndefined, vk::ImageLayout::eTransferDstOptimal);
        copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight));
        //make layout optimal for shader read
    ...
    void endSingleTimeCommands(vk::raii::CommandBuffer& commandBuffer) {
        ...
        vk::SubmitInfo submitInfo{ .pCommandBuffers = &*commandBuffer};
    ...
    void recreateSwapChain() {
        ...
        std::cout << "recreateSwapChain complete" << std::endl;
